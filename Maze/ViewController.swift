    ...
    override func viewDidLoad() {
        ...
        for y in 0 ..< maze.count {
            for x in 0 ..< maze[y].count {
                switch maze[y][x] {
                case 1:
                    let wallView = createView(x: x, y: y, width: cellWidth, height: cellHeight, offsetX:
                                                cellOffsetX, offsetY: cellOffsetY)
                ...
                case 3:
                    ...
                    let goalLmageView = UIImageView(image: UIImage (named: "goal"))
